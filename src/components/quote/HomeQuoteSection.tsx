...
export function HomeQuoteSection({ serviceLevel }: { serviceLevel?: ServiceLevel | null }) {
  return (
    <section
      id="quote-section"
    ...
    >
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-start">
          ...
          >
            <header>
              <h3 className="text-xl font-semibold text-gray-900">WHY QUICKCAR</h3>
              <p className="text-sm text-gray-500 mt-1">Licensed, insured, and built for enterprise-grade logistics.</p>
            </header>
